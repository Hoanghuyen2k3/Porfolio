        ...
        <div id="home" className="intro">
            <div className="nav">
                ...
                <div className="nav-to">
                    ...
                    <a href="https://drive.google.com/file/d/1REb6RtrnzqIvN2aSip1qH8ZIASfC10vr/view?usp=sharing" target="_blank"rel="noopener noreferrer"><img className="git" src={cv} alt="email" /></a>
